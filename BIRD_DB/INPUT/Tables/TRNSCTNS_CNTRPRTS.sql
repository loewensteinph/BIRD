...
(
    ...
    CNTRPRTY_RL NVARCHAR(255) NOT NULL,
    TRNSCTN_ID NVARCHAR(120) NOT NULL,
    TYP_TRNSCTN NVARCHAR(255) NOT NULL,
    IS_PRMRY_PRTCTN_PRVDR BIT,
    JNT_LBLTY NVARCHAR(MAX),
    JNT_LBLTY_AMNT FLOAT, 
    CONSTRAINT [PK_TRNSCTNS_CNTRPRTS] PRIMARY KEY ([CNTRPRTY_ID], [CNTRPRTY_RL], [TRNSCTN_ID], [TYP_TRNSCTN]), 
    CONSTRAINT [FK_TRNSCTNS_CNTRPRTS_CNTRPRTS] FOREIGN KEY ([CNTRPRTY_ID]) REFERENCES [INPUT].[CNTRPRTS]([CNTRPRTY_ID])
);
GO
