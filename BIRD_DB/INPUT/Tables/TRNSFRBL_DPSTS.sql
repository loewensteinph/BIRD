CREATE TABLE [INPUT].[TRNSFRBL_DPSTS]
(
...
EXEC sp_addextendedproperty @name = N'DESCRIPTION',
                            @value = N'Transferable deposits',
                            @level0type = N'SCHEMA',
                            @level0name = N'INPUT',
                            @level1type = N'TABLE',
                            @level1name = N'TRNSFRBL_DPSTS',
                            @level2type = NULL,
                            @level2name = NULL;
GO
EXEC sp_addextendedproperty @name = N'INSTRUCTIONS',
                            @value = N'It comprises all linked enterprises (see article 3, paragraph 3, of the Annex to Commission Recommendation 2003/361/EC) to a counterparty, including the counterparty itself, where the data are not included in the cube "Group data". The data are derived fr',
                            @level0type = N'SCHEMA',
                            @level0name = N'INPUT',
                            @level1type = N'TABLE',
                            @level1name = N'TRNSFRBL_DPSTS',
