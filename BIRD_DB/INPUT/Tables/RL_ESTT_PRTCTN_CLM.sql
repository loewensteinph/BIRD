...
(
    ...
    PRTCTN_ITM_ID NVARCHAR(60) NOT NULL, 
    CONSTRAINT [PK_RL_ESTT_PRTCTN_CLM] PRIMARY KEY ([PRTCTN_ID], [PRTCTN_ITM_ID]), 
    CONSTRAINT [FK_RL_ESTT_PRTCTN_CLM_RL_ESTT_PRTCTN] FOREIGN KEY ([PRTCTN_ITM_ID]) REFERENCES [INPUT].[RL_ESTT_PRTCTN]([PRTCTN_ITM_ID]),
	CONSTRAINT [FK_RL_ESTT_PRTCTN_CLM_RL_ESTT_CLM] FOREIGN KEY ([PRTCTN_ID]) REFERENCES [INPUT].[RL_ESTT_CLM]([PRTCTN_ID])
);
GO
