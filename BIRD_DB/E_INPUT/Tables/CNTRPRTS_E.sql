...
(
    ...
    CONSTRAINT [FK_CNTRPRTS_E_CNTRPRTS_E_HD_OFFICE]
        FOREIGN KEY ([HD_OFFC_UNDRT_ID])
        REFERENCES [E_INPUT].[CNTRPRTS_E] ([CNTRPRTY_ID]),
    CONSTRAINT [FK_CNTRPRTS_E_CNTRPRTS_E_ULTMT_PRNT]
        FOREIGN KEY ([ULTMT_PRNT_UNDRT_ID])
        REFERENCES [E_INPUT].[CNTRPRTS_E] ([CNTRPRTY_ID]),
    CONSTRAINT [FK_CNTRPRTS_E_CNTRPRTS_E_IMMDT_PRNT]
        FOREIGN KEY ([IMMDT_PRNT_UNDRT_ID])
        REFERENCES [E_INPUT].[CNTRPRTS_E] ([CNTRPRTY_ID]),
    CONSTRAINT [PK_CNTRPRTS_E]
        PRIMARY KEY ([CNTRPRTY_ID])
);
GO
