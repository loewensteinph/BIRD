...
(
    ...
    PRTCTN_ID NVARCHAR(120),
    PRTCTN_ALLCTD_VL FLOAT,
    THRD_PRTY_PRRTY_CLMS FLOAT,
    TYP_TRNSCTN NVARCHAR(MAX),
    CONSTRAINT [PK_INSTRMNTS_PRTCTNS_E]
        PRIMARY KEY ([INSTRMNT_UNQ_ID]),
    CONSTRAINT [FK_INSTRMNTS_PRTCTNS_E_PRTCTN_RCVD_E]
        FOREIGN KEY ([PRTCTN_ID])
        REFERENCES [E_INPUT].[PRTCTN_RCVD_E] ([PRTCTN_ID]),
    CONSTRAINT [FK_INSTRMNTS_PRTCTNS_E_RL_ESTT_CLM_E]
        FOREIGN KEY ([PRTCTN_ID])
        REFERENCES [E_INPUT].[RL_ESTT_CLM_E] ([PRTCTN_ID]),
    CONSTRAINT [FK_INSTRMNTS_PRTCTNS_E_LN_E]
